  ...
  return (
    <FeedLayout active="Mes contacts" title="Messages">
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden h-[calc(100vh-180px)] min-h-[400px] flex">
        ...
        <div className={`w-full md:w-80 border-r border-gray-100 flex-col flex-shrink-0 bg-white ${activeConversationId ? 'hidden md:flex' : 'flex'}`}>
        ...
        <div className={`flex-col flex-1 bg-white ${activeConversationId ? 'flex' : 'hidden md:flex'}`}>
          {activeConversationId ? (
            <>
              {/* Header info */}
              <div className="p-4 bg-white border-b border-gray-100 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <button onClick={() => setActiveConversationId(null)} className="md:hidden p-2 text-gray-400 hover:text-gray-600 rounded-xl hover:bg-gray-100 transition-colors">
